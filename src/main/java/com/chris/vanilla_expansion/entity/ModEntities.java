...
public class ModEntities {
    ...
    public static final EntityType<EnergyDragonEntity> ENERGY_DRAGON = register(
            "energy_dragon",
    ...
    private static <T extends Entity> EntityType<T> register(String name, EntityType.Builder<T> builder) {
        ResourceKey<EntityType<?>> key = ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(VanillaExpansion.MOD_ID, name));
