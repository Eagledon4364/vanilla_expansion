...
public class FireDragonEntity extends DragonAnimal {
    ...
    public FireDragonEntity(EntityType<? extends @NotNull FireDragonEntity> type, Level level) {
        super(type, level);
    }
    ...
    public boolean brushOffScute(@Nullable final Entity interactingEntity, final ItemStack tool) {
        if (this.isBaby()) {
            ...
            if (this.level() instanceof ServerLevel level) {
                this.dropFromEntityInteractLootTable(level, ModLootTables.FIRE_DRAGON_SCALE, interactingEntity, tool, this::spawnAtLocation);
    ...
    public static boolean checkFireDragonSpawnRules(
